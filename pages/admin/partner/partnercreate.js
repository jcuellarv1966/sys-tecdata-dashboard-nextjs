...
import FileUploadPartners from "../../../components/FileUploadPartners";
...
export default function AdminPartnerCreateScreen() {
            ...
            <div className="grid md:grid-cols-2 md:gap-0">
              ...
              <div className="flex flex-col items-center justify-center p-1">
                <form className="mx-auto max-w-screen-md" onSubmit={handleSubmit}>
                  <h1 className="mb-4 text-xl">{`Create Partner`}</h1>
                  ...
                  <div className="mb-4">
                    <a href={`/admin/partners`} className="text-black">
                      <FontAwesomeIcon
                        icon={faArrowLeft}
...
AdminPartnerCreateScreen.auth = { adminOnly: true };