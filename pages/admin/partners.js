...
export default function AdminPartnerScreen(props) {
    const { partners, pages } = props;
    ...
    const submitHandler = (e) => {
        ...
        if (querySearch === '') {
            ...
            router.push(`/admin/partners?query=${querySearch}`);
        }
    };
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                dispatch({ type: "FETCH_SUCCESS", payload: props.partners });
            } catch (err) {
    ...
    const deleteHandler = async (partnerId, image) => {
        ...
        try {
            ...
            if (image && image !== "") {
                await axios.post("/api/admin/partners/imagesdeleted", {
                    deletedImage: image,
                });
            }
            ...
            <div className="grid md:grid-cols-8 md:gap-1 mt-4">
                ...
                <div className="overflow-x-auto md:col-span-7 ml-12">
                    <div className="flex justify-between">
                        ...
                        <Link href="/admin/partner/partnercreate">
                        ...
                        <div className="overflow-x-hidden">
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full">
                                    ...
                                    {
                                        <tbody>
                                            {partners.filter(searched(keyword)).map((partner) => (
                                                <tr key={partner._id} className="border-b">
                                                    ...
                                                    <td className=" p-1 text-right">
                                                        <NumberFormat
                                                            value={Number.parseFloat(partner.credit).toFixed(2)}
                                                            displayType={"text"}
                                                    ...
                                                    <td className=" p-1 ">
                                                        <a onClick={() => deleteHandler(partner._id, partner.image)}>
                                                            <FontAwesomeIcon
                                                                icon={faTrashAlt}
...
export async function getServerSideProps({ query }) {
    ...
    const partners = partnerDocs.map(db.convertDocToObjClient);
...
AdminPartnerScreen.auth = { adminOnly: true };
