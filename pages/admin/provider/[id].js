...
export default function AdminProviderEditScreen() {
  ...
  const loadClient = async () => {
    ...
    const { data } = await axios.get(`/api/admin/providers/${providerId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`/api/admin/providers/${providerId}`, { values });
  ...
  return (
    <Layout title={`Edit Provider ${providerId}`}>
...
AdminProviderEditScreen.auth = { adminOnly: true };
