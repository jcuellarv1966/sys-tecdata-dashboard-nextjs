...
export default function AdminWorkerCategoryCreateScreen() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`/api/admin/workerscategories`, {
                name,
                images,
            });
    ...
    return (
        <Layout title={`Create Worker Category`}>
                ...
                <div className="grid-2">
                    {loading ? (
                        ...
                        <form className="mx-auto max-w-screen-lg" onSubmit={handleSubmit}>
                            <h1 className="mb-4 text-xl">{`Create Worker Category`}</h1>
                            <div className="mb-4">
...
AdminWorkerCategoryCreateScreen.auth = { adminOnly: true };
