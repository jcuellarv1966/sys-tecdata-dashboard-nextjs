...
export default function AdminScreenClientContractCreateWithProform() {
  ...
  const [selectedRazSocial, setSelectedRazSocial] = useState("");
  ...
  const loadContractTypes = async () => {
    ...
    setValues({ ...values, contractTypes: data, contractType: data[0]._id });
  ...
  const handleClientChange = async (e) => {
    ...
    setSelectedRazSocial(data.razSocial);

    if (selectedClient !== "") {
      const { data } = await axios.get(`/api/advisory/clientsproforms/clientsproformsfindbyclient/${e.target.value}`);
      if (data !== null) {
        setValues({
          ...values,
          client: selectedClient._id,
          razSocial: selectedClient.razSocial,
      ...
      setSelectedRazSocial(selectedClient.razSocial);
    }
  ...
  const handleProformChange = async (e) => {
    e.preventDefault();
    const { data } = await axios.get(`/api/advisory/clientsproforms/${e.target.value}`);
    setValues({ ...values, observations: data.observations, proformItems: data.proformItems });
    dispatching({ type: 'CART_CLEAR_ITEMS' });
    Cookies.set(
      'cart',
      JSON.stringify({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setValues({...values, razSocial: selectedRazSocial ? selectedRazSocial : razSocial});
      console.log(selectedRazSocial);
      console.log(razSocial);
      await axios.post(`/api/advisory/clientscontracts`, {
        ...
        razSocial,
        observations: observationsContract,
  ...
  return (
    <Layout title={`Create Contract of Client`}>
      <div className="grid md:grid-cols-8 md:gap-1 mt-1">
        <div>
          <SideNavbarAdvisory />
        </div>
        <div className="overflow-x-auto md:col-span-7 ml-12">
          {loading ? (
            ...
            <form className="mx-auto max-w-screen-lg" onSubmit={handleSubmit}>
              <h1 className="mb-2 text-xl text-left">{`Create Client Contract`}</h1>
              ...
              <div className="grid md:grid-cols-2 md:gap-4">
                <div>
                  <div className="md:flex md:items-start mb-2">
                    ...
                    <div className="md:w-2/3">
                      <select
                        ...
                        required
                        defaultValue={""}
                        value={selectedClient ? selectedClient : client}
                  ...
                  <div className="md:flex md:items-start md:text-left mb-2">
                    <div className="md:w-1/3">
                      <label className="block text-black md:text-right mb-1 md:mb-0 pr-4 mt-1" htmlFor="inline-full-name">Address</label>
                    </div>
                    <div className="md:w-2/3">
                      <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 h-7"
                        id="inline-full-name"
                        type="text"
                        value={address}
                        readOnly />
                ...
                <div>
                  <div>
                    <select
                      name="orders"
                      className="ml-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      aria-label="Default select example"
                      size="3"
                      defaultValue={""}
                      onClick={handleProformChange}
              ...
              <div className="grid md:grid-cols-2 md:gap-4 mt-2">
                <div>
                  <div className="md:flex md:items-start mb-1 mr-2">
                    ...
                    <div className="md:w-1/4">
                      <InputNumberContract
                        type="text"
                        required
                        className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 h-7 text-[13px]"
                        name="numberProform"
                    ...
                    <div className="md:w-1/4 mt-1">
                      <div className="flex items-center justify-center mb-2">
                        <input
                          type="checkbox"
                          className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mt-0"
                          name="isCash_Credit"
                          checked={cash_credit}
                          value={cash_credit}
                          onChange={(e) =>
                  ...
                  <div className="flex flex-wrap mb-1 text-sm ml-2">
                    <div className="w-full md:w-1/3 px-0 mb-2 md:mb-0">
                      ...
                      <input
                        type="date"
                        className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 h-7"
                  ...
                  <div className="md:flex md:items-start mt-2 mb-1">
                    <div className="md:w-1/3">
                    ...
                    <div className="md:w-2/3">
                      <select
                        name="product"
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full px-1.5 py-0.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 h-7"
                        aria-label="Default select example"
                        required
                ...
                <div>
                  <div className="md:flex md:items-start mb-0 mr-2">
                    ...
                    <div className="md:w-2/4">
                      <select
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-[13px] rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 h-8 ml-2"
                        aria-label="Default select example"
                        required
                  ...
                  <div className="mb-1 ml-2">
                    <label htmlFor="observationsContract">Observations</label>
                    <textarea
                      type="text"
                      rows="2.5"
                      ...
                      name="observationsContract"
                      placeholder="Observations of Contract..."
                      value={observationsContract}
                      onChange={handleChange}
                    ></textarea>
                  </div>
                </div>
              ...
              <div className="pt-1 pb-0 text-sm text-right px-3 font-bold">
              ...
              <div className="pb-0 text-sm text-right px-3 font-bold">
                IGV : $
                <NumberFormat
...
AdminScreenClientContractCreateWithProform.auth = { adminOnly: true };