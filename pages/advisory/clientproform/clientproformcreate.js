...
export default function AdminScreenClientProformCreate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`/api/advisory/clientsproforms`, {
                numberProform,
                client,
                razSocial,
                observations,
    ...
    return (
        <Layout title={`Create Proform of Client`}>
            <div className="grid md:grid-cols-8 md:gap-1 mt-4">
                ...
                <div className="overflow-x-auto md:col-span-7 ml-12">
                    {loading ? (
                        ...
                        <form className="mx-auto max-w-screen-lg relative h-full" onSubmit={handleSubmit}>
                            <h1 className="mb-4 text-xl text-left">{`Create Client Proform`}</h1>
                                ...
                                <div>
                                    <div className="md:flex md:items-start mb-2">
                                        <div className="md:w-1/4">
                                            <label className="block text-black md:text-right mb-1 md:mb-0 pr-4 mt-1" htmlFor="inline-full-name">Number Proform:</label>
                                        </div>
                            ...
                            <div className="flex flex-wrap mt-2 mb-2 absolute inset-x-0 bottom-0">
...
AdminScreenClientProformCreate.auth = { adminOnly: true };